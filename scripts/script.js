...
var passwordError = document.querySelector('input[name="password"] + p.error');
...
passInput.addEventListener('input', validaPassword);
...
function validaPassword() {
    var passwordValido = /^.{4,8}$/.test(passwordInput.value);
    ...
    if (passwordInput.value === '') {
        ...
        passwordError.textContent = 'La contraseña debe tener entre 4 y 8 caracteres.';
        inputLine.classList.add('invalid');
        inputLine.classList.remove('valid');
    } else {
