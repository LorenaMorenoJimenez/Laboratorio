...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nombreValido && $apellidoValido && $emailValido && $loginValido && $passValido) {
        try {
			...
			$loginExiste = verificarLoginExistente($conn, $login);

            if ($loginExiste) {
                cerrarConexion($conn);
                echo "<script>alert('El login ingresado ya está registrado.'); location.href = 'index.php';</script>";
                exit;
            }
        ...
        <div class="register-container">
            ...
            <form action="index.php" method="post" id="registroForm">
                ...
                <div class="input-line-container">
                    ...
                    <input type="text" name="nombre" class="nombre-input-line" id="nombre" autocomplete="off" maxlength="30"/>
                    <p class="error">
                ...
                <div class="input-line-container">
                    ...
                    <input type="text" name="apellido1" class="apellido1-input-line" id="apellido1" maxlength="30"
                        autocomplete="off" />
                    <p class="error">
                ...
                <div class="input-line-container">
                    ...
                    <input type="text" name="apellido2" class="apellido2-input-line" id="apellido2" maxlength="30"
                        autocomplete="off" />
                    <p class="error">
                ...
                <div class="input-line-container">
                    ...
                    <input type="email" name="email" class="email-input-line" id="email" autocomplete="off" maxlength="255"/>
                    <p class="error">
                        <?php echo $emailError; ?>
                    </p>
                </div>
                ...
                <div class="input-line-container">
                    ...
                    <input type="text" name="login" class="login-input-line" id="login" autocomplete="off" maxlength="10"/>
                    <p class="error">
                        <?php echo $loginError; ?>
                    </p>
                </div>
                ...
                <div class="input-line-container">
                    ...
                    <input type="password" name="pass" class="pass-input-line" id="pass" autocomplete="off" minlength="4" maxlength="8"/>
                    <p class="error">
                        <?php echo $passError; ?>
                    </p>
                </div>
